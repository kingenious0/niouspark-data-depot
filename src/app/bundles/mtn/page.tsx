  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
      <div className="relative overflow-hidden w-full py-16 md:py-24">
        <div className="absolute inset-0 bg-[#FFCC00]/10 dark:bg-[#FFCC00]/5 -z-10 blur-3xl rounded-full opacity-40 dark:opacity-20 pointer-events-none" />
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16 space-y-4">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black font-headline tracking-tighter text-slate-900 dark:text-white">
              MTN <span className="text-[#e6b800] dark:text-[#FFCC00]">Bundles</span>
            </h1>
            <p className="max-w-2xl mx-auto text-lg md:text-xl text-slate-600 dark:text-slate-400 font-light">
              Flash sales and non-expiry data at unbeatable rates. Stay yellow, stay connected.
            </p>
          </div>
